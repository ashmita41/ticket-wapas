        ...
        <section className="app-frame portal-frame" aria-live="polite">
          ...
          {stage === "detail" && <div className="screen portal-screen claim-detail-screen">
            ...
            <div className="account-timeline">
              <div className="done"><i><Tick /></i><span><b>{tr("Refund request created", "रिफंड अनुरोध बना")}</b><small>07 Sep · 6:14 PM</small></span></div>
              <div className="done"><i><Tick /></i><span><b>{tr("Final cancellation confirmed · simulated", "अंतिम रद्दीकरण पुष्ट · नकली")}</b><small>07 Sep · 6:15 PM</small></span></div>
              <div className="done"><i><Tick /></i><span><b>{tr("Remote surrender recorded · simulated", "ऑनलाइन समर्पण दर्ज · नकली")}</b><small>07 Sep · 6:16 PM</small></span></div>
              <div className={selectedClaim.status === "paid" ? "done" : "current"}><i>{selectedClaim.status === "paid" ? <Tick /> : <span />}</i><span><b>{selectedClaim.status === "paid" ? tr("Refund marked paid · simulated", "रिफंड भुगतान दर्ज · नकली") : tr("Payment instruction in progress · simulated", "भुगतान निर्देश जारी · नकली")}</b><small>{selectedClaim.status === "paid" ? "07 Sep · 6:18 PM" : tr("Usually completed within the shown service window", "आमतौर पर दिखाई गई सेवा अवधि में पूरा होता है")}</small></span></div>
            </div>
